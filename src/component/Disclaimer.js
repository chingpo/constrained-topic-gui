...
const Disclaimer = () =>{
  ...
  <div className='page'>
           <h1>本依頼の概要</h1>
    <p>本日は依頼をお引き受けくださり、誠にありがとうございます。本依頼は、「画像クラスタリングの理解向上と画像パッチの調整を通じた人工知能に関する研究」に関するもので、説明可能なAIを目指した実験の一環です。</p>
    ...
    <p >私は、「画像クラスタリングの理解向上と画像パッチの調整を通じた人工知能に関する研究」の参加者実験における目的・方法・予測される問題等について十分な説明を受け、本実験に関する以下の項目を了解しました。</p>
    <ul>
      <li>研究内容について</li>
      <li>その後のアンケートに答える</li>
