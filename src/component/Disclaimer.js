...
const Disclaimer = () =>{
  ...
  <div className='page'>
           <h1>本依頼の概要</h1>
    <p>本日は依頼をお引き受けくださり、誠にありがとうございます。本依頼は、「Human-in-the-loopによって解釈可能な説明を生成できる説明可能AIの研究」に関するもので、説明可能なAIを目指した実験の一環です。</p>

    <h2>お願いする内容は、次の2点です：</h2>
    <ol>
      <li>シミュレーションに参加する。</li>
      <li>アンケートに答える。</li>
    </ol>
    ...
    <p >私は、「Human-in-the-loopによって解釈可能な説明を生成できる説明可能AIの研究」の参加者実験における目的・方法・予測される問題等について十分な説明を受け、本実験に関する以下の項目を了解しました。</p>
    <ul>
      <li>研究内容について</li>
      <li>その後のアンケートに答える</li>
